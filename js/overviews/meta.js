...
var META_THEMES=[
  ...
  { theme:'Superintelligence & the talent war',
  ...
  { theme:'Reality Labs → the glasses pivot',
  ...
  { theme:'The ad engine — GEM & Advantage+',
  ...
  { theme:'Engagement — the inventory machine',
...
function callsBody(){
  ...
  h+='<p class="ov-lede">The key narrative threads from the <b>10 earnings calls</b> Q4 2023 → Q1 2026. Switch lens: <b>By theme</b> traces how each story evolved; <b>By quarter</b> shows what mattered on a given call. Tap any row to expand. (Quarterly guided-vs-delivered revenue is in the <b>Guidance</b> tab.)</p>';
...
function deepDiveHtml(c){
  ...
  h+=subtabs('evolution',[
    { k:'earnings', l:'Earnings Calls', body:callsBody() },
