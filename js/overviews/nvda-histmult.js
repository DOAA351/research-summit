// overviews/nvda-histmult.js — NVIDIA (NVDA) Deep Dive ▸ Valuation ▸ Historic Multiple.
// Structural twin of overviews/amzn-histmult.js; only the data blocks, identity and footnote differ.
//
...
// Split-adjusted monthly price anchors (NVDA 10:1 split, Jun 2024, applied back), interpolated to
// business days with a deterministic wiggle (see mkPrice). The current-price badge is overwritten
// by the live quote once wired; this path only fixes the layout and anchors the historic multiples.
var PRICE_M = [
  ['2022-10-01', 12],['2022-11-01', 15],['2022-12-01', 15],
  ['2023-01-01', 20],['2023-02-01', 23],['2023-03-01', 28],['2023-04-01', 28],['2023-05-01', 39],['2023-06-01', 42],
  ['2023-07-01', 47],['2023-08-01', 47],['2023-09-01', 44],['2023-10-01', 41],['2023-11-01', 47],['2023-12-01', 49],
  ['2024-01-01', 62],['2024-02-01', 79],['2024-03-01', 90],['2024-04-01', 86],['2024-05-01',109],['2024-06-01',122],
  ['2024-07-01',118],['2024-08-01',108],['2024-09-01',118],['2024-10-01',138],['2024-11-01',141],['2024-12-01',137],
  ['2025-01-01',122],['2025-02-01',131],['2025-03-01',116],['2025-04-01',108],['2025-05-01',135],['2025-06-01',158],
  ['2025-07-01',172],['2025-08-01',180],['2025-09-01',178],['2025-10-01',192],['2025-11-01',182],['2025-12-01',175],
  ['2026-01-01',172],['2026-02-01',178],['2026-03-01',166],['2026-04-01',158],['2026-05-01',170],['2026-06-01',176],
  ['2026-07-01',172],['2026-08-01',175],['2026-09-01',175],
];
// Step series: the value in force from that date until the next entry.
// Diluted shares 24.39B and net cash $109.2B are the two real NVDA anchors given; the earlier
// steps taper back to them (split-adjusted shares, net cash building as free cash flow compounds).
var SHARES  = [['2022-10-01',25000],['2023-06-30',24800],['2024-06-30',24600],['2025-06-30',24500],['2026-03-31',24390]]; // millions
var NETDEBT = [['2022-10-01',-5000],['2023-06-30',-12000],['2024-06-30',-26000],['2025-03-31',-55000],['2026-03-31',-109200]];  // $M, negative = net cash

// Fiscal years are treated as calendar years here (mirrors the AMZN template's convention; NVDA's
// real FY ends late January — worth aligning when the vintage archive is wired for real).
...
// consensus said, on each date". EPS in $/share (split-adjusted), EBITDA in $M. The FY2027-2029
// EBITDA and the FY2027-2029 forward-EPS tips tie to the Summit model (261,030 / 379,650 / 487,060
// EBITDA; EPS derived from net income 213,316 / 310,280 / 402,589 over 24,390M shares).
var EST = {
  eps: {
    2022: [['2022-10-01',0.15]],
    2023: [['2022-10-01',0.30],['2023-02-22',0.28],['2023-05-24',0.45],['2023-08-23',0.85],['2023-11-21',1.05],['2024-02-21',1.19]],
    2024: [['2022-10-01',0.55],['2023-05-24',0.90],['2023-11-21',1.80],['2024-02-21',2.40],['2024-08-28',2.75],['2024-11-20',2.90],['2025-02-26',2.99]],
    2025: [['2023-11-21',1.80],['2024-02-21',2.60],['2024-08-28',3.60],['2025-02-26',4.10],['2025-08-27',4.40],['2026-02-25',4.51]],
    2026: [['2024-08-28',3.90],['2025-02-26',5.20],['2025-08-27',6.20],['2026-02-25',6.60],['2026-05-28',6.80]],
    2027: [['2025-08-27',7.80],['2026-02-25',8.40],['2026-05-28',8.60],['2026-08-27',8.75]],
    2028: [['2026-02-25',11.20],['2026-08-27',12.72]],
    2029: [['2026-08-27',16.51]],
  },
  ebitda: {
    2022: [['2022-10-01',9000]],
    2023: [['2022-10-01',12000],['2023-02-22',11000],['2023-05-24',18000],['2023-08-23',30000],['2023-11-21',42000],['2024-02-21',48000]],
    2024: [['2022-10-01',20000],['2023-05-24',34000],['2023-11-21',66000],['2024-02-21',78000],['2024-08-28',88000],['2025-02-26',94000]],
    2025: [['2023-11-21',70000],['2024-02-21',95000],['2024-08-28',120000],['2025-02-26',135000],['2025-08-27',142000],['2026-02-25',146000]],
    2026: [['2024-08-28',130000],['2025-02-26',175000],['2025-08-27',195000],['2026-02-25',205000],['2026-05-28',208000]],
    2027: [['2025-08-27',235000],['2026-02-25',252000],['2026-05-28',258000],['2026-08-27',261030]],
    2028: [['2026-02-25',330000],['2026-08-27',379650]],
    2029: [['2026-08-27',487060]],
  },
};
// ACT[metric] = the LTM figure that stood from each report date. Steps once per print.
var ACT = {
  eps: [['2022-11-16',0.20],['2023-02-22',0.17],['2023-05-24',0.30],['2023-08-23',0.62],['2023-11-21',1.10],
        ['2024-02-21',1.19],['2024-05-22',1.71],['2024-08-28',2.20],['2024-11-20',2.65],['2025-02-26',2.99],
        ['2025-05-28',3.45],['2025-08-27',3.90],['2025-11-19',4.25],['2026-02-25',4.51],['2026-05-28',4.60]],
  ebitda: [['2022-11-16',11000],['2023-02-22',10500],['2023-05-24',16000],['2023-08-23',28000],['2023-11-21',45000],
           ['2024-02-21',58000],['2024-05-22',78000],['2024-08-28',96000],['2024-11-20',115000],['2025-02-26',132000],
           ['2025-05-28',140000],['2025-08-27',150000],['2025-11-19',128000],['2026-02-25',134000],['2026-05-28',138000]],
};
// The last fiscal year fully reported, from each report date — the "Last FY" trailing basis.
var ACT_FY = [['2022-11-16',2021],['2023-02-22',2022],['2024-02-21',2023],['2025-02-26',2024],['2026-02-25',2025]];
var ACT_FY_V = {
  eps:    { 2021:0.35, 2022:0.17, 2023:1.19, 2024:2.99, 2025:4.51 },
  ebitda: { 2021:14000, 2022:10500, 2023:58000, 2024:132000, 2025:162000 },
};
...
// picks the hue** (P/E blue, EV/EBITDA orange) and **the direction picks the weight** —
...
function footHtml(){
  return '<b>How the lines are built.</b> Each is a price divided by a number that stood on that day: '+
    ...
    'the slider. '+
    '<b>⚑ The daily paths and the estimate archive in this tab are synthetic</b> — a plausible path shaped to fix the layout while we agree on the '+
    'idea; nothing here is a price or a multiple anyone published. The only real NVDA anchors are the ones supplied: diluted shares (24.39B), net '+
    'cash ($109.2B) and the Summit-model forward EBITDA and EPS (FY2027-2029), which the forward tips tie to. To make the rest real: daily closes '+
    '(Massive or IBKR), diluted shares and LTM actuals (both already in the Results dataset), net cash (Massive), and the one genuinely missing '+
    'piece — <b>consensus EPS and EBITDA per fiscal year with their revision dates</b>. That last one is a vintage archive, the same shape as the '+
    '<code>estMatrix</code> the Results pane already carries, so the path exists rather than needing a new feed.';
}
...
export var nvdaHistMult = { body: hmBody, init: initHm };
